...
const Footer = () => {
  ...
  return (
    <footer className="spa-gradient-secondary pt-20 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          {/* Brand Section */}
          <div className="lg:col-span-2">
            <h3 className="text-3xl font-bold text-foreground mb-4 font-playfair">
              Glow Haven Spa
            </h3>
            <p className="text-muted-foreground leading-relaxed mb-6 max-w-md">
              Your sanctuary for relaxation, rejuvenation, and renewal. Experience luxury 
              wellness treatments in our peaceful haven designed for your complete comfort.
            </p>
            <Button 
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 bg-accent/20 hover:bg-accent text-accent hover:text-accent-foreground rounded-full flex items-center justify-center spa-transition group"
                  >
                    <IconComponent className="w-5 h-5 group-hover:scale-110 spa-transition" />
                  </a>
                );
              })}
            </div>
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <button 
              onClick={scrollToTop}
              className="text-accent hover:text-accent-hover spa-transition font-medium text-sm"
            >
              Back to Top ↑
            </button>
          </div>
